...
def test_eval():
    ...
    result = traj.eval(model.state(A=1), t_eval=10)
...
def test_eval_teval_is_optional():
    ...
    result = traj.eval(model.state(A=10, B=10))
...
def test_eval_teval_accepts_float():
    ...
    result = traj.eval(model.state(A=10, B=10), t_eval=66)
...
def test_eval_teval_accepts_tuple():
    ...
    result = traj.eval(model.state(A=10, B=10), t_eval=(5, 66))
...
def test_eval_teval_accepts_iterable():
    ...
    result = traj.eval(model.state(A=10, B=10), t_eval=[2, 4, 8, 16, 32])
...
def test_eval_teval_accepts_dataarrays():
    ...
    result = traj.eval(model.state(A=10, B=10), t_eval=times)
...
def test_eval_teval_accepts_scalar_arrays():
    ...
    result = traj.eval(model.state(A=10, B=10), t_eval=times.max())
